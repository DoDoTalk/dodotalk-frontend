...
import dodotalk.feature.chat.presentation.generated.resources.empty_chat
import dodotalk.feature.chat.presentation.generated.resources.no_messages
import dodotalk.feature.chat.presentation.generated.resources.no_messages_subtitle
...
fun EmptyChatSection(
    ...
    Column(
        ...
        Spacer(modifier = Modifier.height(4.dp)) // spacedBy dp까지 포함해서 총 12.dp
        Text(
